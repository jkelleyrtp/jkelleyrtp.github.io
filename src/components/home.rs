            ...
            div { class: "container px-4 mx-auto",
                ...
                ul { class: "list-disc text-left pl-4 lg:pl-20 mb-4 text-gray-500 mx-auto max-w-screen-md",
                    li {
                        ...
                        a {
                            href: "http://github.com/dioxuslabs",
                            class: "font-bold text-blue-600",
                            target: "_blank",
                            "Dioxus"
                        }
                    ...
                    li {
                        ...
                        a {
                            href: "https://www.nasa.gov/langley/",
                            class: "font-bold text-blue-600",
                            target: "_blank",
                ...
                img {
                    class: "mx-auto object-cover rounded-lg md:max-w-screen-md",
                ...
                div { class: "w-full md:w-1/2 px-4 mb-12 lg:mb-16",
                    div { class: "flex flex-wrap -mx-4",
                        ...
                        div { class: "w-full lg:w-2/3 px-4",
                            span { class: "text-xs font-bold text-indigo-500", "10 jun 2022 19:40" }
                            ...
                            a {
                                class: "flex items-center text-lg font-bold text-indigo-500 hover:text-indigo-700",
                                href: "#",
                                span { "Read more" }
                                span { icons::icon_0 {} }
                            }
